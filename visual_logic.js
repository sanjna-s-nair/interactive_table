...
registerOnClick('black_sphere', false, false, [0,1,2], function() {
  assignMat('table_legs', 'black');
}, function() {});

registerOnClick('white_sphere', false, false, [0,1,2], function() {
  assignMat('table_legs', 'white');
}, function() {});

registerOnClick('silver_sphee', false, false, [0,1,2], function() {
  assignMat('table_legs', 'chrome');
}, function() {});
...
registerOnClick('drawer_1.001', false, false, [0,1,2], function() {
  if (status_1 == 'closed') {

    operateAnimation('PLAY', 'drawer_1.001', null, null, 'LoopOnce', 1,
            function() {
      status_1 = 'open';
    }, false);

        } else if (status_1 == 'open') {

    operateAnimation('PLAY', 'drawer_1.001', 1, 30, 'LoopOnce', 1,
            function() {
      status_1 = 'closed';
    }, true);
...
registerOnClick('drawer_2', false, false, [0,1,2], function() {
  if (status_2 == 'closed') {

    operateAnimation('PLAY', 'drawer_2', null, null, 'LoopOnce', 1,
            function() {
      status_2 = 'open';
    }, false);

        } else if (status_2 == 'open') {

    operateAnimation('PLAY', 'drawer_2', 1, 30, 'LoopOnce', 1,
            function() {
      status_2 = 'closed';
    }, true);
